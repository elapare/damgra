        ...
        FOR EACH tt-notas-geradas:
            ...
            IF AVAIL nota-fiscal THEN DO:
                ...
                IF AVAIL if-ped-venda THEN DO:
                    ...
                    IF nota-fiscal.nome-transp <> "" AND nota-fiscal.cod-estabel <> "422" AND nota-fiscal.cod-estabel <> "412" THEN /* COLOCADO A REGRA DO 434 CONFORME SOLICITADO PELO RICARDO POLIMENO 09-10 */  /*solic-318*/ 
                        ASSIGN nota-fiscal.nome-transp  = "".
