...
*******************************************************************************/
{include/i-prgvrs.i RE0190 2.00.00.005}  /*** 010005 ***/
/*------------------------------------------------------------------------
...
DEFINE VARIABLE ed-cod-emitente AS INTEGER FORMAT ">>>>>>9":U INITIAL 17261 
     LABEL "Emitente" 
...
DEFINE VARIABLE ed-dt-trans AS DATE FORMAT "99/99/9999":U 
     LABEL "Data de transa‡Æo" 
     VIEW-AS FILL-IN NATIVE 
     SIZE 12.86 BY .88 NO-UNDO.

DEFINE VARIABLE ed-natur-oper AS CHARACTER FORMAT "X(10)":U INITIAL "1907GI" 
     LABEL "Nat.Opera‡Æo" 
     VIEW-AS FILL-IN NATIVE 
     SIZE 9 BY .88 NO-UNDO.

DEFINE VARIABLE nf-serie AS CHARACTER FORMAT "x(5)":U INITIAL "2" 
     LABEL "Serie" 
     VIEW-AS FILL-IN NATIVE 
...
DEFINE FRAME f-pg-par
     ...
     bt-arquivo-entrada AT ROW 3.25 COL 43.86 HELP
          "Escolha do nome do arquivo"
     ed-dt-trans AT ROW 5.21 COL 17 COLON-ALIGNED
     ed-cod-estabel AT ROW 6.21 COL 16.57 COLON-ALIGNED
     ed-cod-emitente AT ROW 7.21 COL 16.57 COLON-ALIGNED
     ed-natur-oper AT ROW 8.21 COL 16.57 COLON-ALIGNED
     nf-serie AT ROW 8.21 COL 31 COLON-ALIGNED
...
{utp/ut9000.i "ESRE0190" "2.00.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
   ...
   /* FIND  estab-mat 
        WHERE estab-mat.cod-estabel = ed-cod-estabel NO-LOCK no-error.
    IF AVAIL estab-mat THEN do: 
        ASSIGN dt-medio-calc = DATE("01/" + 
                               STRING(MONTH(estab-mat.mensal-ate + 35)) + "/" +
                               STRING(YEAR(estab-mat.mensal-ate + 35))) - 1.
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-arquivo-entrada ed-dt-trans ed-cod-estabel ed-cod-emitente 
          ed-natur-oper nf-serie 
      WITH FRAME f-pg-par IN WINDOW C-Win.
  ENABLE RECT-10 RECT-8 c-arquivo-entrada bt-arquivo-entrada ed-dt-trans 
         ed-cod-estabel ed-cod-emitente ed-natur-oper nf-serie 
      WITH FRAME f-pg-par IN WINDOW C-Win.
...
do  on error undo, return error
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.cod-emitente    = input frame f-pg-par ed-cod-emitente
           tt-param.natur-oper      = input frame f-pg-par ed-natur-oper  
           tt-param.nf-serie        = input frame f-pg-par nf-serie.
    ...
    {include/i-imrun.i rep/esre0190rp.p}
