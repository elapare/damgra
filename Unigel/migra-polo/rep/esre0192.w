...
** autorizacao expressa.F
*******************************************************************************/
{include/i-prgvrs.i RE0192 2.00.00.005}  /*** 010005 ***/
/*------------------------------------------------------------------------
...
&Scoped-Define ENABLED-OBJECTS bt-executar bt-cancelar bt-ajuda im-pg-lay ~
im-pg-log im-pg-par 
...
DEFINE VARIABLE c-cod-estabel AS CHARACTER FORMAT "X(03)":U INITIAL "424" /*solic-318*/
    LABEL "Estabelecimento"  
    VIEW-AS FILL-IN NATIVE 
     SIZE 4 BY .88 NO-UNDO.

DEFINE VARIABLE c-nat-operacao AS CHARACTER FORMAT "X(07)":U INITIAL "" 
    LABEL "Natureza de opera‡Æo"  
    VIEW-AS FILL-IN NATIVE 
     SIZE 8 BY .88 NO-UNDO.

DEFINE VARIABLE c-serie AS CHARACTER FORMAT "X(03)":U INITIAL "" 
    LABEL "Serie"  
    VIEW-AS FILL-IN NATIVE 
     SIZE 4 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-par
     ...
     bt-arquivo-entrada AT ROW 3.25 COL 43.86 HELP
          "Escolha do nome do arquivo"
     ed-dt-trans AT ROW 5.75 COL 20.14 COLON-ALIGNED
     c-cod-estabel AT ROW 6.75 COL 20.14 COLON-ALIGNED
     c-nat-operacao AT ROW 7.75 COL 20.14 COLON-ALIGNED
     c-serie AT ROW 8.75 COL 20.14 COLON-ALIGNED


    text-entrada AT ROW 2.33 COL 4.29 NO-LABEL
     RECT-10 AT ROW 4.75 COL 2.14
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Importa‡Æo de Notas Fiscais"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF C-Win /* Importa‡Æo de Notas Fiscais */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Importa‡Æo de Notas Fiscais */
DO:
...
{utp/ut9000.i "ESRE0192" "2.00.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    {include/i-imvrf.i &programa=esre0192 &versao-layout=001}
...
------------------------------------------------------------------------------*/
  ENABLE bt-executar bt-cancelar bt-ajuda im-pg-lay im-pg-log im-pg-par 
      WITH FRAME f-import IN WINDOW C-Win.
  {&OPEN-BROWSERS-IN-QUERY-f-import}
  DISPLAY c-arquivo-entrada ed-dt-trans c-cod-estabel c-nat-operacao c-serie
      WITH FRAME f-pg-par IN WINDOW C-Win.
  ENABLE c-arquivo-entrada bt-arquivo-entrada ed-dt-trans c-cod-estabel c-nat-operacao c-serie RECT-10 RECT-8 
      WITH FRAME f-pg-par IN WINDOW C-Win.
...
do  on error undo, return error
    ...
    find first natur-oper where natur-oper.nat-operacao = input frame f-pg-par c-nat-operacao no-lock no-error.
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.serie           = input frame f-pg-par c-serie
           tt-param.nat-operacao    = input frame f-pg-par c-nat-operacao.
    ...
    {include/i-imrun.i rep/esre0192rp.p}
