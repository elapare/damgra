...
DEFINE VARIABLE c-cod-estabel-ini AS CHAR label "Estab." FORMAT "x(3)":U 
     VIEW-AS FILL-IN 
     SIZE 4 BY .88
     TOOLTIP "Informe C¢digo do Estabelecimento " INITIAL STRING({cdp\poloestab.i 434}) NO-UNDO. /*solic-318*/ 
...
ASSIGN c-cod-estabel-ini = STRING({cdp\poloestab.i 434}) /*solic-318*/ 
       c-serie           = "20".
