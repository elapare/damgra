...
IF  SUBSTRING(STRING(tt-param.estab-ini,'999'),1,2) = '38'  OR SUBSTRING(STRING(tt-param.estab-ini,'999'),1,3) = '435' OR SUBSTRING(STRING(tt-param.estab-ini,'999'),1,3) = '432' THEN
