...
{include/i-prgvrs.i ESFT0011RP 2.00.00.006}  /*** 010006 ***/
...
c-modelo-logo = SEARCH("logo320.jpg").
     ...
     /* dos silent del VALUE(SESSION:TEMP-DIRECTORY + "esft0011*.x*"). */
...
form header
  STRING(TODAY,"99/99/9999") + " - " + STRING(TIME,"hh:mm") + "h " + FILL("-",250) + " ESFT0011 - 2.00.00.001" FORMAT "X(250)"
...
/*   fullname = SEARCH("esp/planilha/esft0011.xlt") NO-ERROR.*/
   
   /* fullname = SEARCH("i:\ems204\ung\modelos\mod-esft0011a.xls") NO-ERROR. */
    
   fullname = SEARCH("modelos\mod-esft0011r.xlsx") NO-ERROR. 
   ...
   END.
     ...
     c-arq-dest = SESSION:TEMP-DIRECTORY + "esft0011" + string(today,"99-99-9999") + "-" + replace(string(time,"HH:MM:SS"),":","-") + ".xlsx".
...
IF saida = 2 then do:
    ...
    END.
    ELSE DO:
        c-arq-dest = c-dir-dest + "esft0011" + string(today,"99-99-9999") + "-" + replace(string(time,"HH:MM:SS"),":","-") + ".xlsx".
...
def var c-notas as char no-undo.
                         ...
                         C-NOTAS =  '<HTML>' +  
                            ...
                            '</HEAD>' + 
                            '<body>' 
                            + '<p> RELATORIO DE FATURAMENTO - ESFT0011,</p></br>'
                            + '<p>Prezado Usuario,</p>'
          ...
          c-destino = "".
          /*c-destino = search("\\ungusb-vap01\Sistemas\DTS\Log_Prd\esft0011-mail.txt").
