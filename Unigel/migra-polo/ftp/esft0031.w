...
{include/i-prgvrs.i esft0031 2.04.00.000}
...
DEFINE VARIABLE c-nat-operacao-fim AS char FORMAT "x(8)" INITIAL "5905GS"
     VIEW-AS FILL-IN 
     SIZE 11 BY .88
     TOOLTIP "Informe N£mero da Nota Fiscal Final" NO-UNDO.
...
on entry of c-cod-estabel in frame f-pg-sel do:
...
{utp/ut9000.i "esft0031" "2.06.00.001"}
...
Do:
     ...
     for each nota-fiscal no-lock
             where nota-fiscal.cod-emitente  = INPUT FRAME f-pg-sel c-cod-emitente     AND 
                   ...
                   nota-fiscal.nr-nota-fis  >= c-nr-nota-fis-ini:screen-value in frame f-pg-sel AND 
                   nota-fiscal.nr-nota-fis  <= c-nr-nota-fis-fim:screen-value in FRAME f-pg-sel  AND 
...
/*  END. */
  ...
  assign tt-param.usuario              = c-seg-usuario
   ...
   ASSIGN tt-param.c-dt-emis-nota         = INPUT FRAME f-pg-sel c-dt-emis-nota      
    ...
    {include/i-rprun.i ftp/esft0031rp.p} 
