...
define variable c-prog-gerado as character no-undo initial "esft0025".
...
def new shared var c-nr-nota-fis-fim    like nota-fiscal.nr-nota-fis    FORMAT "x(07)"      INITIAL "ZZZZZZZ"  NO-UNDO.
...
def new shared var c-serie              like nota-fiscal.serie          FORMAT "x(05)"      INITIAL ""         NO-UNDO. 
...
DEFINE FRAME f-pg-sel
    ...
    dt-emis-nota-ini label "Per¡odo"
      at row 3 col 18 colon-aligned
      view-as fill-in 
      size 10 by .88
      font 1

    dt-emis-nota-fim no-label 
      at row 3 col 46 colon-aligned
      view-as fill-in 
      size 10 by .88
      font 1

    c-serie label "S‚rie das NFs."
      at row 4 col 18 colon-aligned
      view-as fill-in 
      size 10 by .88
      font 1

    c-nr-nota-fis-ini label "Nota Fiscal"
      at row 5 col 18 colon-aligned
      view-as fill-in 
      size 10 by .88
      font 1

     c-nr-nota-fis-fim no-label 
       at row 5 col 46 colon-aligned
       view-as fill-in 
       size 10 by .88
       font 1

    i-cod-emitente-ini label "C¢digo do Cliente"
   ...
   IMAGE-11 AT ROW 03.00 COL 34
   IMAGE-12 AT ROW 03.00 COL 41
   IMAGE-21 AT ROW 05.00 COL 34
   IMAGE-22 AT ROW 05.00 COL 41
   IMAGE-31 AT ROW 06.00 COL 34
   IMAGE-32 AT ROW 06.00 COL 41
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "Lista de Embarque por N.Fiscal - esft0025"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "esft0025" + ".tmp".
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "ftp/esft0025rp.p".
