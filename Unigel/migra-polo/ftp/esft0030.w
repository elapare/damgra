...
/*------------------------------------------------------------------------
File.............: esft0030.w
Description......: N. Fiscais Emitidas no Per¡odo
Input Parameters : 
Output Parameters: 
Author...........: Amgra
Created..........: 24/11/2009 - Jos‚ Roberto
OBS..............: 
------------------------------------------------------------------------*/
def buffer empresa for mgmulti.empresa.
define variable c-prog-gerado as character no-undo initial "esft0030".
...
def new shared var da-canal-venda-fim like nota-fiscal.cod-canal-venda format ">>9" initial 2 no-undo.
...
DEFINE FRAME f-pg-sel
   ...
   da-dt-confirma-fim no-label
    ...
    da-canal-venda-fim no-label
      at row 3 col 41 colon-aligned
      view-as fill-in 
      size 4 by .88
      font 1

    l-amostra AT ROW 7.5 COL 12
    l-prime   AT ROW 8.5 COL 12
    l-off-spc AT ROW 7.5 COL 25
    l-outros  AT ROW 8.5 COL 25
    l-repos   AT ROW 9.5 COL 12

    RECT-20 AT ROW 6.25 COL 10
      "Filtros" VIEW-AS TEXT
     SIZE 18 BY 1 AT ROW 6.40 COL 12

   IMAGE-1 AT ROW 01.00 COL 34
   IMAGE-2 AT ROW 01.00 COL 39
   IMAGE-3 AT ROW 02.00 COL 34
   IMAGE-4 AT ROW 02.00 COL 39
   IMAGE-5 AT ROW 03.00 COL 34
   IMAGE-6 AT ROW 03.00 COL 39
   WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY
   SIDE-LABELS NO-UNDERLINE THREE-D
   AT COL 3 ROW 2.85
   SIZE 76.86 BY 10.62.
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "N. Fiscais Emitidas no Per¡odo - esft0030"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "esft0030" + ".tmp".
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "ftp/esft0030rp.p".
