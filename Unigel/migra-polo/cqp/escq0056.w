 ...
 **Objetivo.: Laudo de Qualidade - NF de Transferˆncia
 **Data.....: 22/01/2010
 **
 ***************************************************************************/

{include/i-prgvrs.i escq0056 2.04.00.000}
...
DEFINE VARIABLE nr-pedido-transf   AS INTEGER    NO-UNDO.
DEFINE VARIABLE nome-abrev-transf  AS CHAR       NO-UNDO.

/****************** Defini‡ao de Parƒmetros do Relat¢rio *********************/ 
DEFINE VARIABLE pesq-jr AS INTEGER INITIAL 1
    VIEW-AS RADIO-SET vertical
    RADIO-BUTTONS 
    "Por N.Fiscais de Transferˆncias", 1,
 /* "Por Embarques", 2, */
    "Por Nr. de EXT", 2
...
DEFINE VARIABLE c-cod-estabel-ini AS CHAR label "Estabelecimento" FORMAT "x(3)" INITIAL "{cdp\poloestab.i 434}":U /*solic-318*/
     VIEW-AS FILL-IN 
     SIZE 4 BY .88
...
{utp/ut9000.i "escq0056" "2.06.00.001"}
...
/*rotina de montagem do browse */ 
     ...
     IF INPUT FRAME f-pg-sel pesq-jr = 1 THEN DO:   /* por N.Fiscais */
         ...
         FOR EACH nota-fiscal WHERE
             ...
             EACH it-nota-fisc OF nota-fiscal NO-LOCK,
                 ...
                 IF ITEM.fm-codigo = "TPG" OR 
                    ITEM.fm-codigo = "TPH" OR
                    ITEM.fm-codigo = "TOB" THEN NEXT.

                 run pi-acompanhar in h-acomp(input "Nota fiscal: " + nota-fiscal.nr-nota-fis).

                 ASSIGN nr-pedido-transf  = it-nota-fisc.nr-pedido
                        nome-abrev-transf = nota-fiscal.nome-ab-cli.
                 ...
                 IF AVAIL pallet THEN DO:
                     ...
                     ASSIGN nr-pedido-transf = pallet.nr-pedido.

                     FIND FIRST ped-venda WHERE
                         ped-venda.nr-pedido = nr-pedido-transf
                         NO-LOCK NO-ERROR.

                     IF AVAIL ped-venda THEN 
                        ASSIGN nome-abrev-transf = ped-venda.nome-abrev.

                 END.
               
                 FIND FIRST polo-laudo-cliente WHERE
                     polo-laudo-cliente.nome-abrev = nome-abrev-transf
                     NO-LOCK NO-ERROR.
    ...
    /* Fim da Rotina para testar se j  gerado laudo para conferˆncia */
               ...
               ASSIGN tt-digita.nome-abrev   = nome-abrev-transf 
                      ...
                      tt-digita.nr-pedido    = nr-pedido-transf  
...
/*  END. */
  ...
  assign tt-param.usuario              = c-seg-usuario
   ...
   ASSIGN tt-param.c-cod-estabel-ini    = INPUT FRAME f-pg-sel c-cod-estabel-ini
    ...
    {include/i-rprun.i cqp/escq0056rp.p} 
