...
for each ped-venda no-lock
    ...
    IF ( movto-estoq.cod-estabel = "413" OR  movto-estoq.cod-estabel = "423") THEN DO:  /*solic-318*/ 
    ...
    IF (movto-estoq.cod-estabel <> "413" AND  movto-estoq.cod-estabel <> "423") THEN DO:  /*solic-318*/ 
...
/* Rotina para C†lculo de Espessura e Gramatura em Mill Rolls  */
     ...
     IF (c-cod-estabel-ini = "413" OR c-cod-estabel-ini = "423") THEN DO:  /*solic-318*/ 
