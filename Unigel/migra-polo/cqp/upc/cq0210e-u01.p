...
*/
      ...
      IF AVAIL ITEM AND wh-cq0210e-lote:SCREEN-VALUE <> "" and (wh-cq0210e-cod-estabel:SCREEN-VALUE = "412" OR wh-cq0210e-cod-estabel:SCREEN-VALUE = "422") AND i-emitente = 0 THEN DO: /*solic-318*/ 
         ASSIGN wh-cq0210e-un:SCREEN-VALUE = ITEM.un.
         wh-cq0210e-un:SENSITIVE = NO.
