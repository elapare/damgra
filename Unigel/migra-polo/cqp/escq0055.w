...
define variable c-prog-gerado as character no-undo initial "escq0055".
...
def new shared var c-cod-estabel-ini    like pallet.cod-estabel           format "X(3)"         initial "{cdp\poloestab.i 422}"              no-undo. /*solic-318*/
...
def new shared var i-nr-linha-ini       like ord-prod.nr-linha            format "999"          initial 1                  no-undo.
...
DEFINE FRAME f-pg-sel
   ...
   i-nr-linha-ini label "Linha Produá∆o"
     at row 2 col 16 colon-aligned
     view-as fill-in 
     size 5 by .88
     font 1

   i-nr-linha-fim no-label
     at row 2 col 36 colon-aligned
     view-as fill-in 
     size 5 by .88
     font 1  

   dt-producao-ini label "Data Produá∆o"
     at row 4 col 16 colon-aligned
     view-as fill-in 
     size 12 by .88
     font 1

   dt-producao-fim no-label
     at row 4 col 36 colon-aligned
     view-as fill-in 
     size 12 by .88
     font 1

   c-nr-lote-ini label "Nr.do Lote"
     at row 5 col 16 colon-aligned
     view-as fill-in 
     size 12 by .88
     font 1

   c-nr-lote-fim no-label
     at row 5 col 36 colon-aligned
     view-as fill-in 
     size 12 by .88
     font 1
   ...
   c-it-codigo-fim no-label
     at row 6 col 36 colon-aligned
     view-as fill-in 
     size 12 by .88
     font 1

   i-cod-exame-ini label "Cod.Exame"
     at row 7 col 16 colon-aligned
     view-as fill-in 
     size 12 by .88
     font 1

   i-cod-exame-fim no-label
     at row 7 col 36 colon-aligned
     view-as fill-in 
     size 12 by .88
     font 1

   i-cod-comp-ini label "Cod.Componente"
     at row 8 col 16 colon-aligned
     view-as fill-in 
     size 12 by .88
     font 1

   i-cod-comp-fim no-label
     at row 8 col 36 colon-aligned
     view-as fill-in 
     size 12 by .88
     font 1

   "Linhas Produá∆o:"           AT ROW 1.3 col 52
   "001 a 199 - Extrus∆o"       AT ROW 2.3 col 52
   "200 a 299 - Corte Prim†rio" AT ROW 3.3 col 52
   "300 a 399 - Metalizaá∆o"    AT ROW 4.3 col 52
   "400 a 499 - Recorte"        AT ROW 5.3 col 52

   rect-19 AT ROW 01.00 COL 51

   IMAGE-5 AT ROW 02.00 COL 31
   IMAGE-6 AT ROW 02.00 COL 34.7

   IMAGE-7 AT ROW 04.00 COL 31
   IMAGE-8 AT ROW 04.00 COL 34.7

   IMAGE-9  AT ROW 05.00 COL 31
   IMAGE-10 AT ROW 05.00 COL 34.7

   IMAGE-11 AT ROW 06.00 COL 31
   IMAGE-12 AT ROW 06.00 COL 34.7

   IMAGE-13 AT ROW 07.00 COL 31
   IMAGE-14 AT ROW 07.00 COL 34.7

   IMAGE-15 AT ROW 08.00 COL 31
   IMAGE-16 AT ROW 08.00 COL 34.7
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "Propriedades de An†lises de Laboratorio - escq0055"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign v-cod-prog-gerado = "escq0055".
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "escq0055" + ".tmp".
    ...
    assign tt-param.c-cod-estabel-ini   = input frame f-pg-sel c-cod-estabel-ini    
           ...
           tt-param.i-nr-linha-ini      = input frame f-pg-sel i-nr-linha-ini    
           tt-param.i-nr-linha-fim      = input frame f-pg-sel i-nr-linha-fim    
           tt-param.c-nr-lote-ini       = input frame f-pg-sel c-nr-lote-ini     
           tt-param.c-nr-lote-fim       = input frame f-pg-sel c-nr-lote-fim     
           ...
           tt-param.i-cod-exame-ini     = input frame f-pg-sel i-cod-exame-ini      
           tt-param.i-cod-exame-fim     = input frame f-pg-sel i-cod-exame-fim      
           tt-param.i-cod-comp-ini      = input frame f-pg-sel i-cod-comp-ini       
           tt-param.i-cod-comp-fim      = input frame f-pg-sel i-cod-comp-fim       
.
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "cqp/escq0055rp.p".
