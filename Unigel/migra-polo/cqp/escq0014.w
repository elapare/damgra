...
/*------------------------------------------------------------------------
File.............: escq0014.w
Description......: Notas Fiscais que Necessitam de Laudos
Input Parameters : 
Output Parameters: 
Author...........: DATASUL S.A.
Created..........: 03/06/2005 - 10:12 - jrrcampos
OBS..............: Otimiza‡Æo de Performance em 05/03/2007
------------------------------------------------------------------------*/
def buffer empresa for mgmulti.empresa.
define variable c-prog-gerado as character no-undo initial "escq0014".
...
define temp-table tt-param
    ...
    field da-cod-estabel       like nota-fiscal.cod-estabel
    field da-dt-emis-nota      like nota-fiscal.dt-emis-nota
    .
...
def new shared var da-cod-estabel  like nota-fiscal.cod-estabel  format "999" INITIAL "422" no-undo.
...
DEFINE FRAME f-pg-sel
    ...
    da-dt-emis-nota LABEL "Dt.EmissÆo"
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "Notas Fiscais que Necessitam de Laudos - escq0014"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign v-cod-prog-gerado = "escq0014".


def var c-tit as char no-undo.

run grapi/gr2013a.p (input v-cod-prog-gerado,
                    input "Notas Fiscais que Necessitam de Laudos",
...
PROCEDURE enable_UI :
   ...
   DISPLAY  
   da-cod-estabel da-dt-emis-nota
   WITH FRAME f-pg-sel IN WINDOW C-Win.

   ENABLE da-cod-estabel da-dt-emis-nota
   WITH FRAME f-pg-sel IN WINDOW C-Win.
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "escq0014" + ".tmp".

    assign tt-param.da-cod-estabel  = input frame f-pg-sel da-cod-estabel
           tt-param.da-dt-emis-nota = input frame f-pg-sel da-dt-emis-nota
           .
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "cqp/escq0014rp.p".
