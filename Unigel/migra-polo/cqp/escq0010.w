...
/*------------------------------------------------------------------------
File.............: escq0010.w
Description......: Rela‡Æo de Clientes que Necessitam de Laudo
Input Parameters : 
Output Parameters: 
Author...........: DATASUL S.A.
Created..........: 22/02/2005 - 10:12 - jrrcampos
OBS..............: Otimiza‡Æo de Performance em 02/03/2007
------------------------------------------------------------------------*/
def buffer empresa for mgmulti.empresa.
define variable c-prog-gerado as character no-undo initial "escq0010".
...
DEFINE VARIABLE pesq-jr AS INTEGER INITIAL 1
    ...
    RADIO-BUTTONS 
    "Todos os Clientes que Neces.Laudos", 1,
    "Clientes que Neces.Laudos Acompanhando a N.Fiscal", 2
...
DEFINE FRAME f-pg-sel
   ...
   pesq-jr label "Sele‡Æo:"
     at ROW 6 col 12 HELP
     "Escolha Onde Pesquisar as An lises"
    
   RECT-19 AT ROW 05.90 COL 13
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "Rela‡Æo de Clientes que Necessitam de Laudo - escq0010"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign v-cod-prog-gerado = "escq0010".


def var c-tit as char no-undo.

run grapi/gr2013a.p (input v-cod-prog-gerado,
                    input "Rela‡Æo de Clientes que Necessitam de Laudo",
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "escq0010" + ".tmp".
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "cqp/escq0010rp.p".
