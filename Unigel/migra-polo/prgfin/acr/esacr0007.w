...
/*****************************************************************************
**
**       Programa: ESACR0007.w
**
**       Data....: 07/06/2013  
**
**       Autor...: Damgra  -  Edson
**
**       Objetivo: Rela‡Æo de T¡tulos do Contas a Receber - AGING 
                   Unidade de neg¢cio filme 
**
**       OBS.....: 
**
*******************************************************************************/
DEFINE BUFFER empresa      FOR  mgmulti.empresa.
    ...
    define variable c-prog-gerado as character no-undo initial "ESACR0007".
...
def var v-cod-extens-arq     as char    no-undo initial "XLSX".
...
def new shared var dt-corte             AS DATE                        format "99/99/9999"      initial TODAY              no-undo.
def new shared var dt-vencto-ini        AS DATE                        format "99/99/9999"      initial "01/01/2000"       no-undo.
def new shared var dt-vencto-fim        AS DATE                        format "99/99/9999"      initial "12/31/9999"       no-undo.
...
def new shared var c-cod-estabel-fim        AS CHAR                        format "X(03)"           initial "zzz"               no-undo.
...
DEFINE FRAME f-pg-sel
   ...
   c-cod-estabel-ini label "Estabelecimentos"
   ...
   dt-vencto-ini label "Data Vencimento"
     at row 3 col 22 colon-aligned
     view-as fill-in 
     size 12 by .88
     font 1

   dt-vencto-fim no-label
     at row 3 col 46 colon-aligned
     view-as fill-in 
     size 12 by .88
     font 1

   c-cod-esp-ini label "Esp‚cie Docto."
     at row 4 col 22 colon-aligned
     view-as fill-in 
     size 12 by .88
     font 1

   c-cod-esp-fim no-label
     at row 4 col 46 colon-aligned
     view-as fill-in 
     size 12 by .88
     font 1
                                                     
    c-mercado    label "Mercado(I=Int/E=Ext/A-Ambos)"                      
      at row 5 col 30 colon-aligned                   
      view-as fill-in                                 
      size 4 by .88                                  
      font 1                                          


    IMAGE-1 AT ROW 02.00 COL 38
    IMAGE-2 AT ROW 02.00 COL 42

    IMAGE-3 AT ROW 03.00 COL 38
    IMAGE-4 AT ROW 03.00 COL 42


    IMAGE-5 AT ROW 04.00 COL 38
    IMAGE-6 AT ROW 04.00 COL 42
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "Rela‡Æo de T¡tulos do Contas a Receber - ESACR0007"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign v-cod-prog-gerado = "ESACR0007".
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    c-cod-estabel-ini = STRING({cdp\poloestab.i 422}) + "," + STRING({cdp\poloestab.i 434}) + "," + STRING({cdp\poloestab.i 432}). 
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "ESACR0007" + ".tmp".

    assign tt-param.dt-corte        = input frame f-pg-sel dt-corte        
           ...
           tt-param.c-mercado       = input frame f-pg-sel c-mercado    
.
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "prgfin/acr/esacr0007rp.p".
