...
define variable c-prog-gerado as character no-undo initial "esacr0007rp".
...
IF tt-param.destino = 4 THEN DO:
    ...
    ASSIGN c-modelo-planilha = search("modelos/mod-ESACR0006.xls") 
...
DEF VAR c-arquivo AS CHAR NO-UNDO.
    ...
    c-arquivo = c-arq + 'esacr0007' + STRING(time)+ '.xls'.
...
*/
        ...
        IF v_cod_cart_bcia <> "DES" THEN DO:
                ...
                IF i-ge = 0 THEN  DO:
                    ...
                    FOR FIRST it-nota-fisc WHERE it-nota-fisc.nr-nota-fis  = tit_acr.cod_tit_acr AND
                                         it-nota-fisc.serie        = "20"  AND
                                         it-nota-fisc.cod-estabel  = "434" AND
                                         it-nota-fisc.nome-ab-cli   = emitente.nome-abrev NO-LOCK,
                        FIRST ITEM FIELDS (ge-codigo) WHERE ITEM.it-codigo = it-nota-fisc.it-codigo NO-LOCK.
                        i-ge = item.ge-codigo.
                    END.
                ...
                IF i-ge = 0 THEN  DO:
                    ...
                    FOR FIRST it-nota-fisc WHERE it-nota-fisc.nr-nota-fis  = tit_acr.cod_tit_acr AND
                                         it-nota-fisc.serie        = "20"  AND
                                         it-nota-fisc.cod-estabel  = "432" AND
                                         it-nota-fisc.nome-ab-cli   = emitente.nome-abrev NO-LOCK,
                        FIRST ITEM FIELDS (ge-codigo) WHERE ITEM.it-codigo = it-nota-fisc.it-codigo NO-LOCK.
                        i-ge = item.ge-codigo.
                    END.
                ...
                IF i-ge = 0 THEN  DO:
                    ...
                    FOR FIRST it-nota-fisc WHERE it-nota-fisc.nr-nota-fis  = tit_acr.cod_tit_acr AND
                                         it-nota-fisc.serie        = "20"  AND
                                         it-nota-fisc.cod-estabel  = "422" AND
                                         it-nota-fisc.nome-ab-cli   = emitente.nome-abrev NO-LOCK,
                        FIRST ITEM FIELDS (ge-codigo) WHERE ITEM.it-codigo = it-nota-fisc.it-codigo NO-LOCK.
                        i-ge = item.ge-codigo.
                    END.
                ...
                END.
                 ...
                 IF i-ge = 0 THEN DO: 
                    IF tit_acr.cod_estab = "422" OR tit_acr.cod_estab = "434"  OR tit_acr.cod_estab = "424" THEN
                        i-ge = 49.
