...
/*------------------------------------------------------------------------
File.............: escd0005rp.p
Description......: Importa‡Æo de Itens para Requisi‡äes
Input Parameters : 
Output Parameters: 
...
define variable c-prog-gerado as character no-undo initial "escd0005RP".
...
define temp-table tt-param
    ...
    field c-cod-estabel-ini like ord-prod.cod-estabel.
...
DEFINE VARIABLE c-item-codigo AS CHARACTER  NO-UNDO.
DEFINE VARIABLE c-dias-validade AS CHARACTER  NO-UNDO.
DEFINE VARIABLE c-qtde-limite AS CHARACTER  NO-UNDO.
...
assign c-programa     = "escd0005rp"
       c-versao       = "2.00"
       c-revisao      = ".00.000"
       c-titulo-relat = "Importa‡Æo de Itens para Requisi‡äes"
       c-sistema      = "".
...
run pi-inicializar in h-acomp(input "Lendo Itens").

assign v-num-reg-lidos = 0.

run pi-acompanhar in h-acomp ("Aguarde"). 

OUTPUT TO "v:\temp\itens-errado.txt".

DEFINE VARIABLE text-string AS CHARACTER FORMAT "x(78)".

INPUT FROM VALUE(SEARCH("v:\temp\itens.csv")).

  REPEAT:
  
  
  
  IMPORT DELIMITER ";" c-item-codigo c-dias-validade c-qtde-limite  .


      

     FIND FIRST ITEM WHERE
         ITEM.it-codigo = c-item-codigo
         NO-LOCK NO-ERROR.

     IF NOT AVAIL ITEM THEN DO:
   
         PUT c-item-codigo FORMAT "X(09)" AT 01
     ...
     FIND FIRST am-cd-item-vida-util WHERE
         am-cd-item-vida-util.cod-estabel = "422" AND
         am-cd-item-vida-util.it-codigo = c-item-codigo
         NO-ERROR.

     IF NOT AVAIL am-cd-item-vida-util THEN  do:
     
         CREATE am-cd-item-vida-util.
           
         ASSIGN am-cd-item-vida-util.cod-estabel = "422"
                am-cd-item-vida-util.it-codigo   = c-item-codigo.
            
     end.

     ASSIGN 
            am-cd-item-vida-util.dias-validade = int(c-dias-validade)
            am-cd-item-vida-util.qtde-max-req  = int(c-qtde-limite).
