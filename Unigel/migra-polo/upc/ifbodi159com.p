    ...
    FOR FIRST tt-epc 
        ...
        DO TRANS:
            FOR FIRST ped-venda EXCLUSIVE-LOCK 
                ...
                IF ped-venda.cod-estabel = "422" and    /*forcei mas precisa ver para outras empresa quando faz opia de pedido relecioando para comecar  processo*/
                ...
                IF ped-venda.cond-redespa BEGINS "Pedido original relacionado:" THEN do:
                     ...
                     if avail if-ped-venda then do:
                      ...
                      find first b-ped-venda where b-ped-venda.nr-pedido = if-ped-venda.nr-pedido and b-ped-venda.cod-estabel = "422" and
                ...
                IF not AVAIL if-ped-venda and ped-venda.cod-estabel = "422" THEN do:
                ...
                IF AVAIL if-ped-venda THEN DO:
                   ...
                   if avail b-ped-venda  then do:
                        ...
                        if avail buf-emitente and ped-venda.cod-estabel <> "422" and (buf-emitente.nome-abrev <> ped-venda.nome-abrev or 
                ...
                ELSE DO:
                    ...
                    FOR FIRST if-ped-venda EXCLUSIVE-LOCK
                        ...
                        IF NOT CAN-FIND(FIRST tt-erros-geral-aux
                            ...
                            IF if-estabelec.cod-estab-inter = "" THEN DO:
                                c-cod-estab-dest = if if-estabelec.cod-estab-orig = "422" then "434" else  if-estabelec.cod-estab-dest. /* regra fixa porque para 422 TUDO tem de passar pela UNG-RS */
...
------------------------------------------------------------------------------*/
    ...
    FOR EACH ped-item OF ped-venda NO-LOCK:
        ...
        IF AVAIL b-ped-item THEN DO:
           ...
           if ped-venda.cod-estabel = "422" then 
