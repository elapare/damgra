...
------------------------------------------------------------------------------*/
    ...
    END.
    ELSE IF ped-venda.cond-redespa BEGINS "Pedido original relacionado" and ped-venda.cod-estabel <> "432" AND ped-venda.cod-estabel <> "443" THEN DO:  /*solic-318*/  /*permite embarcar pedido do 432*/
