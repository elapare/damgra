...
assign c-prg-vrs = "2.00.00.000"
       c-prg-obj = "essf0003V02".
if  c-arquivo-log <> "" and c-arquivo-log <> ? then do:
    find prog_dtsul
        where prog_dtsul.cod_prog_dtsul = "essf0003V02"
        no-lock no-error.
   ...
   if not avail prog_dtsul then do:
    ...
    put "essf0003V02" at 1 "2.00.00.000" at 69 today at 84 string(time,'HH:MM:SS':U) at 94 skip.
...
DEFINE VARIABLE c-nr-pallet-dmg AS CHARACTER   NO-UNDO.
...
DEFINE VARIABLE c-cod-estabel-esp AS CHARACTER   NO-UNDO.
DEFINE VARIABLE c-nome-abrev-esp  AS CHARACTER   NO-UNDO.
...
IF NOT THIS-PROCEDURE:PERSISTENT THEN DO:
  MESSAGE "l:\servicos\especificos\polo\programas\polo\sfc\essf0003v02.w should only be RUN PERSISTENT.":U
...
DO:
  ...
  if avail item then
     assign fi-desc-item = item.desc-item
            pallet.it-codigo:SCREEN-VALUE IN FRAME f-main = item.it-codigo .
  else
...
DO:
 c-nr-pallet-dmg = pallet.nr-pallet:SCREEN-VALUE in frame f-main.

 assign
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg," ","")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"á","c")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"Ä","C")

    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"Ï","y")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"Ì","Y")    
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"ò","y")
    
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"§","n")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"•","N")    
    

    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"Ö","a")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"∑","A")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"†","a")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"µ","A")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"∆","a")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"«","A")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"É","a")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"∂","A")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"Ñ","a")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"é","A")

    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"ä","e")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"‘","E")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"Ç","e")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"ê","E")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"«","E")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"à","e")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"“","E")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"â","e")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"”","E")

    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"ç","i")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"ﬁ","I")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"°","i")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"÷","I")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"å","i")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"◊","I")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"ã","i")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"ÿ","I")

    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"ï","o")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"„","O")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"¢","o")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"‡","O")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"‰","o")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"Â","O")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"ì","o")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"‚","O")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"î","o")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"ô","O")

    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"ó","u")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"Î","U")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"£","u")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"È","U")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"ñ","u")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"Í","U")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"Å","u")
    c-nr-pallet-dmg = REPLACE(c-nr-pallet-dmg,"ö","U").


 pallet.nr-pallet:SCREEN-VALUE in frame f-main = c-nr-pallet-dmg.
...
------------------------------------------------------------------------------*/
  ...
  find first param-cp no-lock no-error.
  assign pallet.cod-estabel:screen-value in frame f-main = STRING({cdp\poloestab.i 422}) /*solic-318*/  /*param-cp.cod-estabel*/
...
/* _UIB-CODE-BLOCK-END */
    ...
    /*:T N∆o gravar nada no registro antes do dispatch do assign-record e 
      ...
      if INT(pallet.nr-pedido:SCREEN-VALUE IN frame f-main) <> 0 THEN DO:

           
                find first ped-venda
                     where ped-venda.nr-pedido = INT(pallet.nr-pedido:SCREEN-VALUE IN frame f-main)
                     no-lock no-error.
                if not avail ped-venda then do:
                   run utp/ut-msgs.p (input "show",
                                      input 2,
                ...
                find first ped-item
                     where ped-item.nome-abrev   = ped-venda.nome-abrev
                       ...
                       and ped-item.nr-sequencia = INT(pallet.nr-sequencia:SCREEN-VALUE in frame f-main) 
                       and ped-item.it-codigo    = (pallet.it-codigo:SCREEN-VALUE in frame f-main) 
...
END.
    ...
    IF avail pallet  AND pallet.nr-pedido > 0 AND  pallet.nr-pedido <> input frame f-main pallet.nr-pedido  THEN DO:
       ...
       if not avail saldo-estoq AND pallet.situacao > 1 then do:
          ...
          ASSIGN  pallet.nr-pedido:SCREEN-VALUE  in frame f-main = STRing(pallet.nr-pedido)
                  pallet.nr-sequencia:SCREEN-VALUE IN FRAME f-main = STRING(pallet.nr-sequencia).
       ...
       /*valida se palete est† alocado em algum embarque*/
        run pdp\espd0025-1.p (
                     input pallet.nr-pedido,
        ...
        /*s¢ para garantir que n∆o deixa quando estiver saldo alocado por algum motivo*/
    ...
    if INT(pallet.nr-pedido:SCREEN-VALUE) <> 0 and
       input frame f-main  pallet.peso-liquido > 0  then do:
         
        /*valida quantidade e largura de atendimento do pedido final*/
        ...
        IF pallet.situacao = 2 THEN DO:  /*pedido j† efetivado testa largura do palete como pedido destino, se n∆o tiver Ç na efetivaá∆o que testa largura das bobina com o pedido final*/
            FIND FIRST var-result 
               WHERE var-result.item-cotacao = pallet.it-codigo
                 AND var-result.nr-estrut    = int(pallet.cod-refer)
        ...
        run pdp\espd0025-1.p (
                     input  INT(pallet.nr-pedido:SCREEN-VALUE),
                     INPUT  INT(pallet.nr-sequencia:SCREEN-VALUE),
                     INPUT input frame f-main  pallet.peso-liquido,     /*quantidade*/
                     INPUT input frame f-main pallet.it-codigo,
                     INPUT input frame f-main pallet.nr-pallet,
                     INPUT largura-ped,  /*largura*/
                     INPUT  DIEX-ped, /*DIEX*/
                     INPUT  DIIN-ped, /*DIIN*/
                     INPUT "insere").
        ...
        IF NOT adm-new-record AND pallet.situacao = 2  /* 25112014 tava deixando transferir saldo de palete despaletizado*/
    ...
    /* colocado verificaá∆o de quantidade de emendas - amgra - 07/12/07*/
    RUN sfc\essf0003a-amg.p (INPUT INPUT FRAME f-main pallet.nr-pedido).

     IF NOT adm-new-record 
        AND  INT(pallet.nr-pedido:SCREEN-VALUE) <> 0 THEN DO:

        FIND FIRST ped-venda WHERE ped-venda.nr-pedido =  INT(pallet.nr-pedido:SCREEN-VALUE) NO-ERROR.
         
        IF  AVAIL ped-venda THEN  DO:

            assign c-cod-estabel-esp = ped-venda.cod-estabel
                   c-nome-abrev-esp = ped-venda.nome-abrev.

            FIND FIRST ped-item OF ped-venda WHERE ped-item.nr-sequencia =  INT(pallet.nr-sequencia:SCREEN-VALUE)  and
                                                   ped-item.ind-componen < 3 NO-ERROR.
            IF AVAIL ped-item  THEN DO:
               ...
               IF AVAIL if-ped-venda THEN do:
                   FIND FIRST ped-venda WHERE ped-venda.nr-pedido = if-ped-venda.nr-pedido-relac NO-LOCK NO-ERROR.
         
                   IF  AVAIL ped-venda THEN do:                    
                       c-nome-abrev-esp = ped-venda.nome-abrev.
                   END.
               END.
                                     /*mostra alerta de observaá∆o especial cadatrada para cliente final e  item*/
                   RUN pdp\upc\upc-pd4000-a.p (INPUT c-cod-estabel-esp,INPUT ped-item.it-codigo, INPUT c-nome-abrev-esp).
            END.
        END.
     END.
...
ASSIGN INPUT FRAME f-main c-endereco.
    ...
    if avail pallet AND avail ped-item then do:
       assign pallet.cod-refer = ped-item.cod-refer.
    end.
    IF avail pallet THEN OVERLAY(pallet.char-1,1,20) = c-endereco.
