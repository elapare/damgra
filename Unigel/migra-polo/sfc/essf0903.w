...
do trans on error undo, leave:
   ...
   FOR EACH  polo_off_pallet WHERE  NOT polo_off_pallet.log_ems .
        FIND FIRST pallet WHERE  
            pallet.cod-estabel  = STRING({cdp\poloestab.i 422}) AND /*solic-318*/ 
        ...
        IF NOT AVAIL pallet THEN DO:
            ...
            ASSIGN
                pallet.cod-estabel  = STRING({cdp\poloestab.i 422})
    ...
    FOR EACH  polo_off_it_pallet WHERE   polo_off_it_pallet.log_ems = NO AND
         ...
         FIND FIRST it-pallet WHERE  
            it-pallet.cod-estabel  = STRING({cdp\poloestab.i 422}) AND /*solic-318*/ 
         ...
         ASSIGN
           it-pallet.cod-estabel  = STRING({cdp\poloestab.i 422})  /*solic-318*/ 
