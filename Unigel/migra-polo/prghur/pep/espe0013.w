...
DEFINE VARIABLE c_cdn_empresa_fim AS CHARACTER FORMAT "X(03)" INITIAL "420" 
     VIEW-AS FILL-IN 
     SIZE 5 BY .88 TOOLTIP "C¢digo Final da Empresa do Participante".

DEFINE VARIABLE c_cdn_empresa_ini AS CHARACTER FORMAT "X(3)" INITIAL "420" 
     LABEL "Empresa" 
     VIEW-AS FILL-IN 
     SIZE 5 BY .88 TOOLTIP "C¢digo Inicial da Empresa do Participante".

DEFINE VARIABLE c_cdn_estab_fim AS CHARACTER FORMAT "X(05)" INITIAL "422" 
     VIEW-AS FILL-IN 
     SIZE 7 BY .88 TOOLTIP "C¢digo Final do Estabelecimento do Participante".

DEFINE VARIABLE c_cdn_estab_ini AS CHARACTER FORMAT "X(05)" INITIAL "422" 
