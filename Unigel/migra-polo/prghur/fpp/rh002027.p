...
for each funcionario no-lock
    ...
    assign Description = if funcionario.cdn_estab = "321" then "UNG USP - " + cargo.des_cargo else if funcionario.cdn_estab = "351" then "UNG CSP - " + cargo.des_cargo else if funcionario.cdn_estab = "352" then "UNG CCB - " + cargo.des_cargo else if funcionario.cdn_estab = "353" then "UNG CSJ - " + cargo.des_cargo else if funcionario.cdn_estab = "354" then "UNG CGJ - " + cargo.des_cargo else if funcionario.cdn_estab = "362" then "UNG ECM - " + cargo.des_cargo else if funcionario.cdn_estab = "381" then "UNG LCN - " + cargo.des_cargo else if funcionario.cdn_estab = "383" then "UNG LSP - " + cargo.des_cargo else if funcionario.cdn_estab = "391" then "UNG PCN - " + cargo.des_cargo else if funcionario.cdn_estab = "392" then "UNG PSP - " + cargo.des_cargo else if funcionario.cdn_estab = "393" then "UNG PCM - " + cargo.des_cargo else if funcionario.cdn_estab = "401" then "UNG ACM - " + cargo.des_cargo else if funcionario.cdn_estab = "404" then "UNG ACM - " + cargo.des_cargo else if funcionario.cdn_estab = "421" then "UNG PSP - " + cargo.des_cargo else if funcionario.cdn_estab = "422" then "UNG PMT - " + cargo.des_cargo else if funcionario.cdn_estab = "341" then "TRS CSP - " + cargo.des_cargo else if funcionario.cdn_estab = "342" then "TRS CGJ - " + cargo.des_cargo else if funcionario.cdn_estab = "343" then "TRS SPP - " + cargo.des_cargo else "Editar RH0020AA".
