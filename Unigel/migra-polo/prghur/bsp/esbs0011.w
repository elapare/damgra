...
DEF  TEMP-TABLE tt-beneficio NO-UNDO
    ...
    FIELD log_beneficio_utiliz     AS LOG FORMAT "Sim/NÆo"
    FIELD log_beneficio_utiliz_aux AS LOG FORMAT "Sim/NÆo".
...
DEFINE VARIABLE i-empresa-ini   AS char    INITIAL "420" NO-UNDO.
DEFINE VARIABLE i-empresa-fim   AS char    INITIAL "420" NO-UNDO.
DEFINE VARIABLE i-estab-ini     AS char    INITIAL "422" NO-UNDO.
DEFINE VARIABLE i-estab-fim     AS char    INITIAL "422" NO-UNDO.
...
DEFINE VARIABLE l-gera-arq AS LOGICAL INITIAL no 
     LABEL "Gera arquivos de lotes para importa‡Æo:" 
     VIEW-AS TOGGLE-BOX
...
DEFINE VARIABLE i-cod-empresa-fim AS CHAR FORMAT "x(03)":U INITIAL "420" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE i-cod-empresa-ini AS CHAR FORMAT "x(03)":U INITIAL "420" 
     LABEL "Empresa" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE VARIABLE i-cod-estab-ini AS CHAR FORMAT "x(05)":U INITIAL "421" 
...
DEFINE FRAME f-pg-par
     ...
     c-arquivo-saida AT ROW 9.88 COL 3.29 HELP
          "Nome do arquivo de destino para exporta‡Æo" NO-LABEL
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Integra‡Æo de Movimentos Unimed"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 29
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF C-Win /* Integra‡Æo de Movimentos Unimed */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Integra‡Æo de Movimentos Unimed */
DO:
...
ON LEAVE OF i-mes-ref IN FRAME f-pg-par /* Mˆs Folha */
DO:
      ...
      h-campo = im-pg-lay:HANDLE IN FRAME f-import .
        ...
        DO WHILE valid-handle(h-campo ):
          ...
          IF h-campo:TYPE = "TEXT" THEN 
              if  h-campo:SCREEN-VALUE <> "Parƒmetros" THEN
              
               h-campo:VISIBLE = NO.
              ELSE
                   h-campo:SCREEN-VALUE = "Sele‡Æo".
    ...
    FOR EACH tt-beneficio WHERE
        ...
        IF beneficio.idi_param_benefic = 1 THEN DO: /*Beneficio por estabelecimento*/
            ...
            if  not avail param_benefic_estab then do:
                ...
                /*    Verifica se funcionÿrio estÿ afastado      */
                ...
                if  tt-movto_benefic.cdn_depend_func > 0 then do:
                    ...
                    /*   Se Separado   */
                        ...
                        /*    Valida data mÿxima dependente para receber benef!cio   */
                        /*  Masculino  */  
