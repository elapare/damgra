...
DEF VAR d-valor-204       AS DEC       NO-UNDO.
...
FOR EACH val_unit_form_fp WHERE 
                ...
                val_unit_form_fp.cdn_val_unit_fp= 204  NO-LOCK.                

                d-valor-204 = val_unit_form_fp.val_calcul_efp .
END.
...
ASSIGN    
d-vl-dep =  ROUND (d-valor-204 * d-perc-func / 100,2)
d-vl-emp =  d-valor-204 - d-vl-dep.
