...
**
*******************************************************************************/
define variable c-prog-gerado as character no-undo initial "escc0027RP".
...
FORM tt-digita.linha        COLUMN-LABEL "Linha"      FORMAT ">>>>>9"    AT 001
     ...
     tt-digita.num-pedido   COLUMN-LABEL "Nr.Pedido"  FORMAT ">>>>>>>>9"      AT 097
     tt-digita.nr-contrato  COLUMN-LABEL "Nr.Contrato" FORMAT ">>>>>>>>9"      AT 108

     
     tt-digita.ct-codigo    COLUMN-LABEL "Conta"      FORMAT "x(8)"            AT 119
     tt-digita.sc-codigo    COLUMN-LABEL "C.Custo"    FORMAT "x(8)"            AT 129              
     tt-digita.narrativa    COLUMN-LABEL "Mensagem de Erro"  FORMAT "x(50)"    AT 141
          with down width 210 no-box stream-io frame f-relat-09-132.
...
FORM tt-digita.gerado-ordem COLUMN-LABEL "Ger"        FORMAT "Sim/N∆o"   AT 001
     ...
     tt-digita.num-pedido   COLUMN-LABEL "Nr.Pedido"  FORMAT ">>>>>>>>9"       AT 110
     tt-digita.nr-contrato  COLUMN-LABEL "Nr.Contrato" FORMAT ">>>>>>>>9"      AT 120
     tt-digita.ct-codigo    COLUMN-LABEL "Conta"      FORMAT "x(8)"            AT 132
     tt-digita.sc-codigo    COLUMN-LABEL "C.Custo"    FORMAT "x(8)"            AT 143              
     tt-digita.narrativa    COLUMN-LABEL "Narrativa ou Mensagem Erro"  FORMAT "x(50)"    AT 153
     with down width 210 no-box stream-io frame f-relat-02-132.


form HEADER
    fill("-", 190) format "x(190)" SKIP 
    WITH DOWN WIDTH 190 NO-BOX STREAM-IO FRAME f-relat-linha.

form HEADER
    fill(" ", 190) format "x(190)" SKIP 
    WITH DOWN WIDTH 190 NO-BOX STREAM-IO FRAME f-relat-branco.
...
form header
    fill("-", 170) format "x(190)" skip
    c-empresa c-titulo-relat at 50
    "Folha:" at 122 page-number(str-rp) at 128 format ">>>>9" skip
    fill("-", 112) format "x(110)" today format "99/99/9999"
    "-" string(time, "HH:MM:SS") skip(1)
    with stream-io width 190 no-labels no-box page-top frame f-cabec.
...
form header
    ...
    "-" string(time, "HH:MM:SS") skip(1)
    with stream-io width 190 no-labels no-box page-top frame f-cabper.

run grapi/gr2004.p.

form header
    c-rodape format "x(190)"
    with stream-io width 190 no-labels no-box page-bottom frame f-rodape.
...
FOR EACH tt-digita where
    tt-digita.log-erro = YES :      
     ...
     if tt-digita.nr-contrato > 0 then 
          tt-digita.narrativa = "*** Confimada - " + tt-digita.narrativa.
          else
          tt-digita.narrativa = "*** N«O CONFIRMADA - " + tt-digita.narrativa.          
          
    assign v-num-reg-lidos = v-num-reg-lidos + 1.
    run pi-acompanhar in h-acomp(input string(v-num-reg-lidos)). 
     
          
    /***  C‡DIGO PARA SA÷DA EM 190 COLUNAS ***/
