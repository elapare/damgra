...
/*------------------------------------------------------------------------
File.............: esce0009.w
Description......: REG. CONTR.PRODU€ÇO E ESTOQUE
Input Parameters : 
Output Parameters: 
Author...........: DATASUL S.A.
Created..........: 04/01/2006 - 11:11 - Jos‚ Roberto R. Campos
OBS..............: Otimiza‡Æo de Performance em 01/03/2007
------------------------------------------------------------------------*/
def buffer empresa for mgmulti.empresa.
define variable c-prog-gerado as character no-undo initial "esce0009".
...
DEFINE FRAME f-pg-sel
   ...
   c-pag-ini label "P gina Inicial"
    ...
    c-mes label "Mˆs"
      at row 5 col 25 colon-aligned
      view-as fill-in 
      size 06 by .88
      font 1

    c-ano label "Ano"
      at row 6 col 25 colon-aligned
      view-as fill-in 
      size 06 by .88
      font 1
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "REG. CONTR.PRODU€ÇO E ESTOQUE - esce0009"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "esce0009" + ".tmp".
    ...
    assign tt-param.c-cod-estabel      = input frame f-pg-sel c-cod-estabel   
           ...
           tt-param.c-pag-ini          = input frame f-pg-sel c-pag-ini       
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "cep/esce0009rp.p".
