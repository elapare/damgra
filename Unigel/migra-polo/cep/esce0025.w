...
/*------------------------------------------------------------------------
File.............: esce0025.w
Description......: Consumo de Embalagem no Per¡odo
Input Parameters : 
Output Parameters: 
...
define variable c-prog-gerado as character no-undo initial "esce0025".
...
def new shared var c-ge-codigo-ini      LIKE item.ge-codigo            format 99 initial 90  no-undo.
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "Consumo de Embalagem no Per¡odo - esce0025"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "esce0025" + ".tmp".
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "cep/esce0025rp.p".
