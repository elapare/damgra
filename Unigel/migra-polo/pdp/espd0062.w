...
Input Parameters : 
Output Parameters: 
Author...........: Amgra - J.Roberto
Created..........: 04/08/2011 
OBS..............: 
-----------------------------------------------------------------------*/

define variable c-prog-gerado as character no-undo initial "espd0062".
...
define temp-table tt-param
    ...
    FIELD ep-codigo-ini        AS character
    field cod-estabel-prod     AS CHAR 
    field cod-estabel-fat      AS CHAR 
...
DEFINE FRAME f-pg-sel
   ...
   c-cod-estabel-prod label "Estab.Produ‡Æo"
     at row 2 col 20 colon-aligned
     view-as fill-in 
     size 7 by .88
     font 1

   c-cod-estabel-fat label "Estab.Faturamento"
     at row 3 col 20 colon-aligned
     view-as fill-in 
     size 7 by .88
     font 1             

   i-cod-emitente-ini label "Cod.Cliente"
   ...
   i-cod-emitente-fim no-label
     at row 4 col 41 colon-aligned
     view-as fill-in 
     size 7 by .88
     font 1

   c-estado-ini label "UF Faturamento"
     at row 5 col 20 colon-aligned
     view-as fill-in 
     size 7 by .88
     font 1

   c-estado-fim no-label
     at row 5 col 41 colon-aligned
     view-as fill-in 
     size 7 by .88
     font 1

   IMAGE-7 AT ROW 04.00 col 31
   IMAGE-8 AT ROW 04.00 col 38
   
   IMAGE-9  AT ROW 05.00 col 31
   IMAGE-10 AT ROW 05.00 col 38
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "Relacionamento de Nat.Opera‡äes entre Estabelecimentos - espd0062"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign v-cod-prog-gerado = "espd0062".
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "espd0062" + ".tmp".

    assign tt-param.ep-codigo-ini     = input frame f-pg-sel i-ep-codigo-ini     
           tt-param.cod-estabel-prod  = input frame f-pg-sel c-cod-estabel-prod 
           tt-param.cod-estabel-fat   = input frame f-pg-sel c-cod-estabel-fat  
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "pdp/espd0062rp.p".
