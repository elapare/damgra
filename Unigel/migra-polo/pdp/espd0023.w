...
define variable c-prog-gerado as character no-undo initial "espd0023a".
...
def new shared var c-cod-estabel     like ped-venda.cod-estabel   format "x(03)"    initial "{cdp\poloestab.i 422}"   no-undo./*solic-318*/
...
DEFINE VARIABLE  c-reduzida           LIKE conta-contab.reduzida        NO-UNDO.
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "Ajusta Referˆncia do Pallet p/ a Refer. do Pedido - espd0023a"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
DO:
    ...
    DO:
        ...
        IF AVAIL PARAM-global THEN DO:
           ...
           IF AVAIL PARAM-estoq THEN DO:
            ...
            FIND FIRST conta-contab WHERE
                ...
                conta-contab.conta-contabil = PARAM-estoq.conta-transf
                NO-LOCK NO-ERROR.
    
    
            ASSIGN c-reduzida   = conta-contab.reduzida
                   c-ct-codigo  = param-estoq.ct-tr-transf
                   c-sc-codigo  = param-estoq.sc-tr-transf
                   c-conta-contabil-jr = conta-contab.conta-contabil.
        ...
        find first conta-contab where conta-contab.ep-codigo      = i-empresa and
                                      conta-contab.conta-contabil = c-conta-contabil-jr
                                      no-lock no-error.
        ...
        find first conta-contab where conta-contab.conta-contabil = c-conta-contabil-jr and
           ...
           do transaction on error undo blk-do, return no-apply:
               ...
               /*TRANSFERENCIA*/
                   ...
                   assign tt-movto.cod-versao-integracao  = 1
                          ...
                          tt-movto.cod-prog-orig          = "espd0023a"
...
assign v-cod-prog-gerado = "espd0023a".
...
PROCEDURE pi-executar :
       ...
       /*  END. */
         ...
         assign tt-param.usuario              = c-seg-usuario
           ...
           {include/i-rprun.i pdp/espd0023arp.p} 
