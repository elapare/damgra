...
/*------------------------------------------------------------------------
File.............: espd0014.w
Description......: SITUA€ÇO DO PEDIDO DE VENDA
Input Parameters : 
Output Parameters: 
Author...........: DATASUL S.A.
Created..........: 02/03/04 - 10:12 - jrrcampos
OBS..............: Otimiza‡Æo de Performance em 21/02/2007
------------------------------------------------------------------------*/

define variable c-prog-gerado as character no-undo initial "espd0014".
...
def new shared var da-cod-estabel like ped-venda.cod-estabel format "999" initial "{cdp\poloestab.i 422}" no-undo./*solic-318*/
...
DEF NEW GLOBAL SHARED VAR i-nr-sequencia-indiv AS INT  NO-UNDO.
...
DEFINE FRAME f-pg-sel
   ...
   da-nr-pedido label "Nr.Pedido"
     at row 3 col 14 colon-aligned
     view-as fill-in 
     size 11 by .88
     font 1

    i-nr-sequencia label "Sequencia Ped."
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "SITUA€ÇO DO PEDIDO DE VENDA - espd0014"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    IF i-nr-pedido-indiv <> 0 THEN
       ASSIGN da-cod-estabel:screen-value IN FRAME f-pg-sel = string(cod-estabel-indiv) 
              da-nr-pedido:screen-value IN FRAME f-pg-sel   = STRING(i-nr-pedido-indiv)
              i-nr-sequencia:SCREEN-VALUE IN FRAME f-pg-sel = STRING(i-nr-sequencia-indiv).
...
PROCEDURE enable_UI :
   ...
   DISPLAY  
   da-cod-estabel da-nr-pedido i-nr-sequencia
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "espd0014" + ".tmp".

    assign tt-param.da-cod-estabel = input frame f-pg-sel da-cod-estabel
           tt-param.da-nr-pedido   = input frame f-pg-sel da-nr-pedido
           tt-param.nr-sequencia   = input frame f-pg-sel i-nr-sequencia
        .
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "pdp/espd0014rp.p".
