...
**       Autor...: DATASUL S.A.
** 
**       Objetivo: SITUA€ÇO DO PEDIDO DE VENDA
**
...
FORM "Nr. do Pedido.:" AT 001 ped-venda.tp-pedido   FORMAT "x(1)" AT 017
     ...
     "Saldo … Paletizar:" AT 036 saldo-jr              FORMAT "->>>,>>>,>>9.99" AT 055 
...
assign c-programa     = "espd0014rp"
       c-versao       = "2.00"
       c-revisao      = ".00.000"
       c-titulo-relat = "SITUA€ÇO DO PEDIDO DE VENDA"
       c-sistema      = "".
...
*/        
 ...
 IF tt-param.destino <> 4 THEN DO:
        ...
        if  tt-param.parametro then do:
           ...
           disp stream str-rp "   SITUA€ÇO DO PEDIDO DE VENDA"
