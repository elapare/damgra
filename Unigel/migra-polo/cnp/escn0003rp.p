...
{include/i-prgvrs.i escn0003rp 1.00.00.000}
...
def shared var c-cod-estabel   like contrato-for.cod-estabel   format "x(03)"     no-undo.  /*solic-318*/ 
...
create tt-param.
tt-param.destino = 2.
tt-param.arquivo = session:temp-directory + "escn0003" + ".tmp".
