...
{include/i-prgvrs.i escn0003 1.00.00.000}
...
def new  shared var c-cod-estabel   like contrato-for.cod-estabel   format "x(03)"    initial "422"   no-undo.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Importa Planilha da Tabela de Preáos de Fornecedores - escn0003"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
{utp/ut9000.i "escn0003" "2.00.00.000"}
...
assign v-cod-prog-gerado = "escn0003".
...
ASSIGN c-arquivo-entrada = dir-jr + "\escn0003" + ".xls". 
...
do on error undo, return error on stop  undo, return error:
    ...
    if  tt-param.destino = 2 then
        ...
        assign tt-param.arquivo = session:temp-directory + "escn0003" + ".tmp".
  ...
  /*  {include/i-rpexb.i}
    ...
    {include/i-rprun.i cnp\escn0003rp.p}
