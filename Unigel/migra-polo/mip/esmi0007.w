...
define variable c-prog-gerado as character no-undo initial "esmi0007".
...
def new shared var dt-emissao-fim       as date    format 99/99/9999    initial 12/31/9999        no-undo.
...
DEFINE FRAME f-pg-sel
   ...
   i-nr-ord-produ-ini  label "Ord.de Manutená∆o"
   ...
   dt-emissao-ini  label "Dt.Emiss∆o OM"
     at row 3 col 20 colon-aligned
     view-as fill-in 
     size 15 by .88
     font 1
   
   dt-emissao-fim  no-label 
     at row 3 col 51 colon-aligned
     view-as fill-in 
     size 15 by .88
     font 1

   c-cd-equipto-ini  label "Cd.Equipamento"
     at row 4 col 20 colon-aligned
     view-as fill-in 
     size 15 by .88
     font 1

   c-cd-equipto-fim  NO-LABEL
     at row 4 col 51 colon-aligned
     view-as fill-in 
     size 15 by .88
     font 1 
     
   i-opcao at ROW 6.7 col 28 NO-LABEL 
   
   RECT-21 AT ROW 6.5 COL 18

   "Opá‰es:" AT ROW 6.7 COL 20
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "Relat¢rio de OM's Suspensas- esmi0007"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "esmi0007" + ".tmp".
    ...
    assign tt-param.c-cod-estabel       = input frame f-pg-sel c-cod-estabel      
           ...
           tt-param.c-cd-equipto-ini    = input frame f-pg-sel c-cd-equipto-ini   
           tt-param.c-cd-equipto-fim    = input frame f-pg-sel c-cd-equipto-fim   
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "mip/esmi0007rp.p".
