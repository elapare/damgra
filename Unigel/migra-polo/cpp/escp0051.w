...
/*------------------------------------------------------------------------
File.............: escp0051.w
Description......: ESTATISTICA DE PRODUCAO POR MµQUINA MENSAL
Input Parameters : 
Output Parameters: 
Author...........: DATASUL S.A.
Created..........: 24/03/04 - 11:08 - jrrcampos
OBS..............: Otimizador de Performance em 07/03/2007
                   17/08/07 este era escp0051, pois o escp0051 ficou produ‡Æo por dia e 
                   este ficou como na versÆo original dia e mes

------------------------------------------------------------------------*/
define buffer empresa for mgmulti.empresa.
define variable c-prog-gerado as character no-undo initial "escp0051".
...
def new shared var c-cod-estabel-ini like movto-estoq.cod-estabel format "x(3)"  no-undo.  /*solic-318*/ 
def new shared var c-cod-estabel-fim like movto-estoq.cod-estabel format "x(3)"  no-undo.  /*solic-318*/ 
...
DEFINE FRAME f-pg-sel
   ...
   IMAGE-1 AT ROW 01.00 COL 33
   IMAGE-2 AT ROW 01.00 COL 38
   WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY
   SIDE-LABELS NO-UNDERLINE THREE-D
   AT COL 3 ROW 2.85
   SIZE 76.86 BY 10.62.
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "ESTATISTICA DE PRODUCAO POR MµQUINA MENSAL - escp0051"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign v-cod-prog-gerado = "escp0051".


def var c-tit as char no-undo.

run grapi/gr2013a.p (input v-cod-prog-gerado,
                    input "RELA€ÇO DE PEDIDOS COM PAR¶METROS ERRADOS",
...
run grapi/gr2013a.p (input v-cod-prog-gerado,
                    input "ESTATISTICA DE PRODU€ÇO POR MµQUINA",
                    input  v-cod-prog-gerado,   
                    output c-tit,
                    output c-arquivo,
                    input v-cod-extens-arq).
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "escp0051" + ".tmp".
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "cpp/escp0051rp.p".
