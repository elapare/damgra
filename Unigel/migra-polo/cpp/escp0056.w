...
/*------------------------------------------------------------------------
File.............: escp0056.w
Description......: Pallets Produzidos no Per¡odo
Input Parameters : 
Output Parameters: 
...
define variable c-prog-gerado as character no-undo initial "escp0056".
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "EFICIÒNCIA DE CORTE POR SLITTER / PRODUTO - escp0056"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "escp0056" + ".tmp".
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "cpp/escp0056rp.p".
