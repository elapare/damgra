...
/*------------------------------------------------------------------------
File.............: escp0057.w
Description......: Observa‡äes de Qualidade em Mill Rolls
Input Parameters : 
Output Parameters: 
...
define variable c-prog-gerado as character no-undo initial "escp0057".
...
DEFINE FRAME f-pg-sel
   ...
   c-dt-data-ini label "Data de Produ‡Æo"
     at row 3 col 22 colon-aligned
     view-as fill-in 
     size 13 by .88
     font 1

   c-dt-data-fim no-label
     at row 3 col 45 colon-aligned
     view-as fill-in 
     size 13 by .88
     font 1

    c-it-codigo-ini label "C¢digo do Filme"
    ...
    IMAGE-4 AT ROW 03.00 COL 43
    IMAGE-5 AT ROW 05.00 COL 38
    IMAGE-6 AT ROW 05.00 COL 43
    IMAGE-7 AT ROW 06.00 COL 38
    IMAGE-8 AT ROW 06.00 COL 43
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "Observa‡äes de Qualidade em Mill Rolls"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign v-cod-prog-gerado = "escp0057".


def var c-tit as char no-undo.

run grapi/gr2013a.p (input v-cod-prog-gerado,
                    input "Observa‡äes de Qualidade em Mill Rolls",
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "escp0057" + ".tmp".

    assign tt-param.c-cod-estabel-ini = input frame f-pg-sel c-cod-estabel-ini
           tt-param.c-dt-data-ini     = input frame f-pg-sel c-dt-data-ini
           tt-param.c-dt-data-fim     = input frame f-pg-sel c-dt-data-fim
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "cpp/escp0057rp.p".
