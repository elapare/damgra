...
IF VALID-HANDLE(h-nr-ord-produ-amg) THEN DO:
    ...
    IF AVAIL ord-prod THEN DO:
       ...
       IF  AVAIL estabelec AND (estabelec.ep-codigo <> "420" AND estabelec.ep-codigo <> "410") THEN RETURN.  /*solic-318*/ 
   end.
...
IF  p-ind-event = "depois-estorno" AND p-ind-object = "bt-ok" THEN DO:
    ...
    IF valid-handle(h-nr-ord-produ-amg) THEN DO:
         ...
         IF AVAIL ord-prod THEN DO:
            ...
            IF AVAIL lin-prod AND AVAIL estabelec AND (estabelec.ep-codigo = "420" OR estabelec.ep-codigo = "410" ) THEN DO:  /*solic-318*/ 
