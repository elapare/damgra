...
/*------------------------------------------------------------------------
File.............: escp0059.w
Description......: Altera‡Æo de Linha de Produ‡Æo em Ordem de Produ‡Æo
Input Parameters : 
Output Parameters: 
...
DEFINE TEMP-TABLE tt-digita no-undo
    ...
    FIELD nr-ord-produ         LIKE movto-estoq.nr-ord-produ FORMAT ">>>>>>>>9"     LABEL "Ordem Produ‡Æo"
...
def new shared var c-cod-estabel-ini like movto-estoq.cod-estabel        format "x(03)"    initial "422"           no-undo.
...
DEFINE FRAME f-pg-sel  
    ...
    i-nr-ord-produ-ini label "Ordem de Produ‡Æo"
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "Altera‡Æo de Linha de Produ‡Æo em Ordem de Produ‡Æo - escp0059"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
DO: 
    ...
    IF NOT AVAIL lin-prod THEN DO:
       ...
       run utp/ut-msgs.p (input "show":U, input 32582, "Linha de Produ‡Æo Destino NÆo Existe").
    ...
    IF NOT AVAIL am-cp-linha-gr-maq THEN DO:
       ...
       run utp/ut-msgs.p (input "show":U, input 32582, "Linha de Produ‡Æo Destino sem Relacionamento").
       APPLY "entry" TO i-nr-linha-destino IN FRAME f-pg-sel.
       return NO-apply.
...
run grapi/gr2013a.p (input v-cod-prog-gerado,
                    input "Altera‡Æo de Linha de Produ‡Æo em Ordem de Produ‡Æo",
